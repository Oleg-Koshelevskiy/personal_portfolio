...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>
          Udemy course &quot;Build Responsive Real-World Websites with HTML and
          CSS&quot; certificate
        </li>
        <li>Sertified Front-End developer (SkillUP course)</li>
      </ul>
    ),
  },
];
...
const AboutSection = () => {
  ...
  return (
    <section className="text-white mt-20" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:pt-24 xl:px-16">
        <Image
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React, Redux, Next.JS, MongoDB, HTML, CSS
